...
I'm a passionate **Fronted Web Developer** exploring the world of React, Node.js, and modern web technologies. My journey began with small projects that often broke spectacularly — and that's exactly how I fell in love with programming. Every crash, bug, and late-night debug session taught me something new, shaping the developer I am today.
...
When I step away from the screen, you might find me exploring new tech communities, experimenting with creative UI designs, or debating whether tabs are truly better than spaces.
...
- 🛠️ &nbsp;Currently working with **HTML5, CSS3, JavaScript, React, Tailwind CSS, Node.js, MongoDB**
